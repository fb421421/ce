package com.gaming.ce.server.protocol.websocket;
...
import com.gaming.ce.server.handler.NettySecurityFilter;
...
public class WebSocketChannelInitializer extends
	...
	@Autowired
	private com.gaming.ce.server.handler.NettyServerHandler serverHandler;
